<%@ Page Title="" Language="C#" MasterPageFile="~/ApplicationPage.master" AutoEventWireup="true" CodeFile="BuildingView.aspx.cs" Inherits="BuildingView" %>
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td class="style3" style="width: 21px; font-size: medium">
                :</td>
            <td class="style6" style="width: 126px">
                <asp:Label ID="Label19" runat="server" style="color: #CC3300" Text="Label"></asp:Label>
            </td>
            <td>
                &nbsp;</td>
        </tr>
